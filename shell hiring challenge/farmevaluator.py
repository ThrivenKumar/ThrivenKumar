...
def sendAEP():
    ...
    turb_coords    =  getTurbLoc(r'/Users/thrivenkumar/Desktop/e976ac76f64e11ea/Shell_Hackathon Dataset/turbineloctest.csv')
    # Load the power curve
    power_curve    =  loadPowerCurve('/Users/thrivenkumar/Desktop/e976ac76f64e11ea/Shell_Hackathon Dataset/power_curve.csv')
    # Pass wind data csv file location to function binWindResourceData.
    # Retrieve probabilities of wind instance occurence.
    wind_inst_freq =  binWindResourceData(r'/Users/thrivenkumar/Desktop/e976ac76f64e11ea/Shell_Hackathon Dataset/WindData/wind_data_2007.csv')
    ...
    print('Calculating AEP for NEW Dataset......')
    AEP = totalAEP(turb_diam, turb_coords, power_curve, wind_inst_freq)
    print('Total power produced by the wind farm is: ', "%.12f"%(AEP), 'GWh')
